...
revoke all on public.chats, public.messages, public.scheduled_actions from public, anon, authenticated;
grant select, insert, update on public.chats, public.messages, public.scheduled_actions to service_role;
